...
public:
    ...
    audio::ListeningAudioFeatureStore& GetListeningAudioFeatures() {
        return listening_audio_features_;
    }
    bool IsIdle();
...
private:
    ...
    std::atomic<bool> listening_audio_enabled_{false};
    std::atomic<bool> listening_audio_noise_floor_reset_pending_{true};
    std::atomic<uint32_t> input_sequence_{0};
    bool service_stopped_ = true;
    bool audio_input_need_warmup_ = false;
    audio::ListeningAudioFeatureStore listening_audio_features_;
    float listening_audio_noise_floor_ = 0.008f;
