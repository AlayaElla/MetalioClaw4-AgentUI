...
Es8388AudioCodec::Es8388AudioCodec(void* i2c_master_handle, i2c_port_num_t i2c_port, int input_sample_rate, int output_sample_rate,
    ...
    audio_codec_i2c_cfg_t i2c_cfg = {
        .port = static_cast<uint8_t>(i2c_port),
        .addr = es8388_addr,
